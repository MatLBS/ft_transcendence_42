    ...
    en: {
      translation: {
        ...
        home: {
          ...
          controles_2:
            "Right Player (IA or Friend) Arrow Up ➡️ Up | Arrow Down ➡️ Down",
          modes: "🏆 Game modes",
        ...
        solo: {
          sentence:
            "You will be playing on the left side, the IA on the right ! Are you ready ?",
          button: "Ready !",
        },
        tournament: {
        ...
        notFound: {
          title:
            "Oops! The page you're looking for has disappeared into space...",
        ...
        internalServerError: {
          ...
          message:
            "Our servers are experiencing a space disturbance, please try again later.",
        },
      },
    },
    es: {
      translation: {
        ...
        home: {
          ...
          controles_2:
            "Jugador Derecho (IA o Amigo) Flecha Arriba ➡️ Arriba | Flecha Abajo ➡️ Abajo",
        ...
        solo: {
          sentence:
            "¡Jugarás en el lado izquierdo, la IA en el derecho! ¿Estás listo?",
          button: "¡Listo!",
        },
        tournament: {
        ...
        verify: {
          ...
          regexPassword:
            "La contraseña debe tener al menos 8 caracteres y contener al menos una letra mayúscula, una letra minúscula y un carácter especial.",
          invalidFormat:
        ...
        notFound: {
          ...
          message:
            "No se preocupe, siempre puede volver a la página de inicio.",
          help: "Volver a la página de inicio",
        },
        unauthorized: {
          title: "¡Se requiere autenticación para acceder a esta área!",
          message:
            "Por favor, inicie sesión para continuar su exploración espacial.",
        },
        forbidden: {
        ...
        internalServerError: {
          ...
          message:
            "Nuestros servidores están experimentando una perturbación espacial, por favor, inténtelo de nuevo más tarde.",
        },
      },
    },
    pt: {
      translation: {
        about: {
          ...
          titleDev: "Desenvolvedor Full Stack",
        },
        game: {
          local: "Local",
          solo: "Solo",
        ...
        home: {
          ...
          controles_2:
            "Jogador Direito (IA ou Amigo) Seta para Cima ➡️ Cima | Seta para Baixo ➡️ Baixo",
          modes: "🏆 Modos de jogo",
        ...
        solo: {
          sentence:
            "Você jogará no lado esquerdo, a IA no direito! Está pronto?",
          button: "Pronto!",
        },
        tournament: {
        ...
        verify: {
          ...
          regexPassword:
            "A senha deve ter pelo menos 8 caracteres e conter pelo menos uma letra maiúscula, uma letra minúscula e um caractere especial.",
          invalidFormat:
        ...
        notFound: {
          title:
            "Ops! A página que você está procurando desapareceu no espaço...",
          message:
            "Não se preocupe, você ainda pode voltar para a página inicial!",
          help: "Voltar para a página inicial",
        },
        unauthorized: {
          title: "Autenticação necessária para acessar esta área!",
          message:
            "Por favor, faça login para continuar sua exploração espacial.",
        },
        forbidden: {
        ...
        internalServerError: {
          ...
          message:
            "Nossos servidores estão enfrentando uma perturbação espacial, por favor, tente novamente mais tarde.",
        },
      },
    },
    fr: {
      translation: {
        about: {
          ...
          titleDev: "Développeur Full Stack",
        },
        game: {
          local: "Local",
          solo: "Solo",
        ...
        home: {
          ...
          controles_2:
            "Joueur droit (IA ou ami) : Flèche haut ➡️ Haut | Flèche bas ➡️ Bas",
          modes: "🏆 Modes de jeu",
        ...
        solo: {
          sentence:
            "Vous jouerez du côté gauche, l'IA du côté droit ! Êtes-vous prêt ?",
          button: "Prêt !",
        },
        tournament: {
        ...
        verify: {
          ...
          invalidFormat:
            "Type de fichier invalide. Seules les images sont autorisées.",
        ...
        notFound: {
          title:
            "Oups ! La page que vous recherchez s'est envolée dans l'espace...",
          message:
            "Ne vous inquiétez pas, vous pouvez toujours retourner à la page d'accueil !",
          help: "Retour à l'accueil",
        },
        unauthorized: {
          title: "Identification requise pour accéder à cette zone !",
          message:
            "Veuillez vous authentifier pour poursuivre votre exploration spatiale.",
        },
        forbidden: {
          title: "Accès interdit à cette galaxie !",
          message:
            "Vous n'avez pas les autorisations nécessaires pour explorer cette zone.",
        },
        internalServerError: {
          title: "Une erreur cosmique s'est produite !",
          message:
            "Nos serveurs rencontrent une perturbation spatiale, veuillez réessayer plus tard.",
        },
      },
    },
  },
